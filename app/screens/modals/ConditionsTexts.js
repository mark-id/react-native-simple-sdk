...
export default class ConditionsTexts extends Component {
    ...
    conditionsPersonalizationParagraphs = [
        ...
        { paragraph: 'Trečiame žingsnyje turite padaryti asmens tapatybę patvirtinančio dokumento priekinės ir galinės pusės (jeigu tai yra asmens tapatybės kortelė) nuotrauką. Dokumentas turi būti neuždengtas, tinkamai apšviestas ir gerai matomi visi jame esantys duomenys. Atvaizde neturi būti pašalinių daiktų ar asmenų. Dokumentas turi būti nepažeistas. Asmens tapatybę patvirtinančio dokumento vaizdas yra užfiksuojama paspaudus „Fiksuoti vaizdą“. Užfiksavus vaizdą, galite įvertinti nuotrauką bei padaryti ją pakartotinai arba baigti identifikaciją spausdamas „Baigti identifikaciją“.'},
        { paragraph:'Spausdami mygtuką “Baigti identifikaciją” patvirtinate perduodamų duomenų teisingumą.'},
    ];

    conditionsDataProtectionParagraphs = [
        { paragraph: 'Tapatybės nustatymo proceso metu padarytos Jūsų veido atvaizdo bei Jūsų asmens dokumento nuotraukos, vaizdo įrašai ir identifikavimo ataskaita bus tiesiogiai realiu laiku perduodami MarkID Jūsų asmens tapatybės nustatymo tikslu. MarkID užtikrina Jūsų asmens duomenų, skirtų Jūsų tapatybės nustatymui nuotoliniu būdu, saugumą, taip pat Jūsų asmens duomenų apsaugą nuo atsitiktinio ar neteisėto sunaikinimo, pakeitimo, atskleidimo, taip pat nuo bet kokio kito neteisėto tvarkymo.'},
        { paragraph: 'Duomenų valdytojas - MarkID, juridinio asmens kodas MarkID, buveinės adresas Žalgirio g. 90, elektroninio pašto adresas dyanovyanovsky@gmail.com, telefono Nr. +37069941454.'},
        { paragraph: 'Duomenų tvarkytojas – UAB Mark ID, juridinio asmens kodas 305098955, buveinės adresas Žalgirio g. 90, Vilnius, elektroninio pašto adresas info@markid.eu, telefono Nr. +370 672 89813.'},
        { paragraph: 'Duomenų tvarkymo tikslas - asmens tapatybės nustatymas, kaip tai reglamentuota Lietuvos Respublikos Pinigų plovimo ir teroristų finansavimo prevencijos įstatyme bei Finansinių nusikaltimų tyrimo tarnybos prie Lietuvos Respublikos Vidaus reikalų ministerijos direktoriaus 2016-11-30 įsakymu Nr. V-314 patvirtintuose Techniniuose reikalavimuose kliento tapatybės nustatymo procesui, kai tapatybė nustatoma nuotoliniu būdu, naudojantis elektroninėmis priemonėmis, leidžiančiomis tiesioginio vaizdo perdavimą.'},
        { paragraph: 'Duomenų saugojimo laikotarpis apibrėžiamas vadovaujantis Lietuvos Respublikos Pinigų plovimo ir teroristų finansavimo prevencijos įstatymu.'},
    ];
    ...
    render() {
        return (
            <View>
                ...
                {this.conditionsPersonalizationParagraphs.map( (texts, index) => (
                ...
                {this.conditionsDataProtectionParagraphs.map( ( newText, index ) => (
                    <Text style={ styles.paragraph } key={index}>
                        { newText.paragraph }
                        {"\n"}
                    </Text>
